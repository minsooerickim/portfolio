...
export default function CurrentExperience({ currentExperiences }: InferGetStaticPropsType<typeof getStaticProps>) {
    return (
      <motion.ul>
...
export function Item({ experience }) {
    ...
    return (
      ...
      >
          ...
          />
          {isOpen && <ExperienceDetails details={experience.details} imgs={experience.imgs}/>}
      </motion.li>
    );
}
