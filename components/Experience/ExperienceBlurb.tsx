...
const ExperienceBody = ({ company, position, date, description, stack, location, githubLink, webLink }: BodyProps) => (
    <motion.div 
      className='drop-shadow-xl group flex flex-col w-full p-5 rounded-lg bg-card hover:bg-border cursor-pointer'
    >
...
export default function ProjectBlurb({ company, position, date, description, stack, location, githubLink, webLink }: BlurbProps) {
    return (
        <>
        {
            githubLink ?
